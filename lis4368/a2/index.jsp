...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->
	...
	<div class="container">
		<div class="starter-template">
					...
					<img src="img/hello.png" class="img-responsive center-block" alt="correctly hid directory files" />
				...
				<br />
					...
					<br />
					<img src="img/queryresult.png" class="img-responsive center-block" alt="Database Connectivity Using Servlets" />
