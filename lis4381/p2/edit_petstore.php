						...
						<?php
							...
							try 
							{
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="email" placeholder="Example: jdoe@email.com" value="<?php echo $result['pst_email']; ?>"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="YTDSales" placeholder="Example: 100.00 (no other charcters)" value="<?php echo $result['pst_ytd_sales']; ?>"/>
										</div>
								</div>
