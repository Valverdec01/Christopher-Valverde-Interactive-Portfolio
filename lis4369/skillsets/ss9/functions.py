def get_requirements():
    ...
    print("\nProgram Requirements:\n"
        + "1. Sets (Python data structure): mutable heterogeneuos, unordered sequence of elements, *but* cannot hold duplicate values.\n"
...
def using_sets():
    ...
    print("\nOutput:")
    print("Input: Hardcoded -- no user inoput. See three examples above.")
