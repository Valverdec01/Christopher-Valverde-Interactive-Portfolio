...
CREATE SCHEMA IF NOT EXISTS cv19d;
SHOW WARNINGS;
USE cv19d;
...
(NULL, NULL, NULL,'Peter', 'Parker', '20 Ingram Street', 'New York', 'NY', '102862341', 'pparker@msn.net', '1988-09-12', 'c', NULL),
(NULL, NULL, NULL,'Jane', 'Thompson', '13563 Ocean Drive', 'Seattle', 'WA', '032084409', 'jthompson@gmail.com', '1978-05-08', 'c', NULL),
...
(NULL, NULL, NULL,'Ben', 'Avery', '6432 Thunderbird Ln', 'Sioux Falls', 'SD', '562638332', 'bavery@gmail.com', '1983-12-24', 'a', NULL),
(NULL, NULL, NULL,'Arthur', 'Curry', '3304 Euclid Avenue', 'Miami', 'FL', '000219932', 'acurry@yahoo.com', '1975-12-15', 'j', NULL),
(NULL, NULL, NULL,'Diana', 'Price', '994 Green Street', 'Las Vegas', 'NV', '332044882', 'dprice@sympatico.com', '1974-02-04', 'j', NULL),
(NULL, NULL, NULL,'Adam', 'Jurris', '98435 Valencia Dr.', 'Gulf Shores', 'AL', '870219932', 'Ajurris@gmail.com', '1995-01-31', 'j', NULL),
(NULL, NULL, NULL,'Judy', 'Sleen', '54321 Rover ct.', 'Billings', 'MT', '672047723', 'Judysleen@yahoo.com', '1995-05-04', 'j', NULL),
(NULL, NULL, NULL,'Bill', 'Neiderheim', '43567 Netherland blvd', 'South Bend', 'IN', '320219932', 'bneiderheim@yahoo.com', '1980-06-04', 'j', NULL);
...
(NULL, 5, 6402338394, 'f', 'fax number not working'),
...
(NULL, 'fifth district court of appeal', '300 south beach street', 'daytona beach', 'fl', '323125292', 3862258600, '5dca@us.fl.gov', 'http://www.5dca.org/', NULL);
...
(NULL, 14, 3, '2011-07-19', 'i', 150000, 'freshman justice'),
(NULL, 11, 3, '2012-04-16', 'i', 130000, NULL);
...
VALUES
(NULL, 13, 'civil', 'client says that his logo is being used without consent to promote rival businss', '2010-09-09', NULL, 'copyright infringement'),
(NULL, 12, 'criminal', 'client is charged for assaulting her husband during an argument', '2009-11-19', '2010-12-23', 'assault'),
(NULL, 14, 'civil', 'client broke his ankle while shopping. no wet floor sign was posted even though floor had been mopped', '2008-05-06', '2008-07-23', 'slip and fall'),
(NULL, 11, 'criminal', 'client was charged with stealing televisions from his former employment', '2009-10-09', NULL, 'grand theft'),
(NULL, 15, 'criminal', 'client charged with possesion of 10 grams of cocaine', '2011-09-15', '2012-10-10', 'possesion of narcotics');
