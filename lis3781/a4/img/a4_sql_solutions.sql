...
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'cv19d')
DROP DATABASE cv19d;
GO

IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'cv19d')
CREATE DATABASE cv19d;
GO
...
(2, 2, 6, 2, 5, 5.99, 29.95, NULL),
(3, 3, 4, 1, 30, 3.99, 119.7, NULL),
(4, 4, 1, 5, 15, 18.99, 284.85, NULL),
(5, 5, 9, 4, 6, 11.99, 71.94, NULL),
(5, 1, 5, 6, 10, 9.99, 199.8, NULL),
(4, 2, 6, 7, 5, 5.99, 29.95, NULL),
(3, 3, 4, 8, 30, 3.99, 119.7, NULL),
(2, 4, 1, 9, 15, 18.99, 284.85, NULL),
(1, 4, 2, 10, 6, 11.99, 71.94, NULL),
(1, 5, 3, 11, 10, 11.99, 119.9, NULL),
(2, 1, 4, 4, 11, 13.99, 159.9, NULL),
(3, 2, 3, 2, 22, 3.99, 48.5, NULL),
(4, 3, 8, 7, 23, 15.28, 55.2, NULL),
(4, 4, 5, 6, 34, 17.28, 33.3, NULL),
(1, 1, 3, 6, 32, 20.29, 49.2, NULL),
(2, 5, 4, 2, 49, 28.99, 39.2, NULL),
(1, 1, 2, 1, 38, 22.99, 150.22, NULL),
(2, 2, 5, 11, 24, 36.29, 130.22, NULL),
(4, 5, 8, 10, 44, 95.22, 110.25, NULL),
(3, 4, 4, 8 ,23, 69.96, 160.20, NULL),
(4, 3, 2, 9, 26 ,63.32, 100.10, NULL),
(4, 4, 5, 11, 30 , 34.44, 160.20, NULL),
(2, 4, 8, 7, 55, 95.33, 145.99, NULL),
(1, 3, 2, 8, 60, 78.99, 93.22, NULL);
